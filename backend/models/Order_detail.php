...
class Order_detail extends Model
{
  ...
  VALUES(:username, :password)";
    ...
    public function getAllPagination($params = [])
    {
        ...
        $start = ($page - 1) * $limit;
        $obj_select = $this->connection
            ->prepare("SELECT * FROM order_details  WHERE TRUE $this->str_search
    ...
    {
        $obj_select = $this->connection
            ->prepare("SELECT COUNT(id) FROM order_details WHERE TRUE $this->str_search");
        $obj_select->execute();
    ...
    {
        $obj_select = $this->connection
            ->prepare("SELECT * FROM order_details WHERE order_id = $id");
        $obj_select->execute();
...
VALUES(:username, :password, :first_name, :last_name, :phone, :address, :email, :avatar, :jobs, :facebook, :status)");
    ...
    public function delete($id)
    {
        $obj_delete = $this->connection
            ->prepare("DELETE FROM order_details WHERE id = $id");
