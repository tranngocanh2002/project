...
<div class="timeline-items">
    ...
    <form action="" method="post">
        <table class="table table-bordered" border="1" cellspacing="0" cellpadding="16">
            <tbody>
            <tr>
            ...
            <tr>
                <td colspan="5" style="text-align: right" class="product-payment">
                    <a href="san_pham.html" class="continue">Tiếp tục mua hàng</a>
                    <input type="submit" name="submit" value="Cập nhật lại giá" class="update_pay">
                    <a href="thanh-toan.html" class="go_pay">Đến trang thanh toán</a>
                </td>
            </tr>
            </tbody>
        </table>
